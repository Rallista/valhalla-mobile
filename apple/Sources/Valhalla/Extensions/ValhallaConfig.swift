...
extension ValhallaConfig {
    ...
    init(tileDirURL: URL? = nil,
         tileExtract: URL? = nil) throws {
        // TODO: Not found!
        ...
        let mjolnir = Mjolnir(admin: defaultConfig.mjolnir.admin,
                              ...
                              tileDir: tileDirURL?.relativePath ?? defaultConfig.mjolnir.tileDir,
                              tileExtract: tileExtract?.relativePath ?? defaultConfig.mjolnir.tileExtract,
