 ...
 *
 * This class provides a Kotlin interface to the native Valhalla C++ routing engine.
 * It handles configuration management, JSON serialization, and routing requests.
 *
 ...
 * @param valhallaConfigManager Manages the Valhalla configuration file on the device. Defaults to a new instance.
...
class Valhalla(
     ...
     * @return The route response wrapped in a [ValhallaResponse] sealed class based on the requested format.
