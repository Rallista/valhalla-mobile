...
sealed class ValhallaResponse {
   ...
   *
   * This format provides compatibility with the OSRM (Open Source Routing Machine) API. Use this
   * when you need interoperability with OSRM-based systems.
   *
   ...
   *
   * This is the default format and provides the full feature set of Valhalla's routing
   * capabilities.
   *
